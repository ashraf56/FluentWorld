...
const About = () => {
  ...
  <div className="hero-content text-center text-neutral-content">
    ...
    <div className="">
      <h1 className="mb-5 text-5xl text-start font-bold">About us</h1>
      <h1 className="mb-5 text-2xl text-start font-bold">Building Bridges through Language Learning</h1>

      <div className='max-w-5xl mx-auto'>
        <p className="mb-5 text-start ">At FluentWorld, we believe that language learning is an empowering journey that opens doors to new opportunities, bridges cultural gaps, and enriches lives. With a passion for languages and a commitment to excellence, we are dedicated to helping individuals of all ages and backgrounds unlock their language potential.
        <br />
