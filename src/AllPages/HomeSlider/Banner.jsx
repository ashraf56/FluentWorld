      ...
      <div className="hero  backdrop-blur-sm" >
        ...
        <div className="hero-content flex-col-reverse lg:flex-row-reverse text-black">
          ...
          <div>
            ...
            <Link to={'/Classes'}>
              <button className='btn transition hover:duration-[3s] ease-in-out transform bg-gradient-to-tr from-[#3952f5]  to-[#fc4778] my-5 btn-md w-52  hover:from-[#fc4778] hover:to-[#3952f5]   border-0  text-white' >Explore</button>
            </Link>
          </div>
        </div>
      </div>
